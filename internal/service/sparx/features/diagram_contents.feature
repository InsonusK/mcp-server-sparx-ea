Feature: Diagram contents and layout (method 3)
  As the MCP server
  I want the elements placed on a diagram and their rectangles by id or path
  So that an agent can reason about a diagram's layout
  ...
  Scenario: Reading a Cyrillic diagram
